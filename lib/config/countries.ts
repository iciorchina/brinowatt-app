...
export const COUNTRIES: CountryConfig[] = [
  {
    ...
    pvInstallationCostPerKWp: 800, bessCostPerKWh: 300, heatPumpCostPerKW: 850,
    currency: 'EUR', vatRate: 19, co2GridFactor: 0.380,
    gasPricePerKWh: 0.105, oilPricePerKWh: 0.11,
  },
  {
    code: 'FR', name: 'France', flag: '🇫🇷',
    electricityPrice: 0.23, solarIrradiance: 1350, feedInTariff: 0.06,
    pvInstallationCostPerKWp: 800, bessCostPerKWh: 300, heatPumpCostPerKW: 800,
    currency: 'EUR', vatRate: 20, co2GridFactor: 0.052,
    gasPricePerKWh: 0.095, oilPricePerKWh: 0.105,
  },
  {
    code: 'IT', name: 'Italy', flag: '🇮🇹',
    electricityPrice: 0.28, solarIrradiance: 1550, feedInTariff: 0.05,
    pvInstallationCostPerKWp: 800, bessCostPerKWh: 300, heatPumpCostPerKW: 780,
    currency: 'EUR', vatRate: 22, co2GridFactor: 0.280,
    gasPricePerKWh: 0.11, oilPricePerKWh: 0.115,
  },
  {
    code: 'ES', name: 'Spain', flag: '🇪🇸',
    electricityPrice: 0.26, solarIrradiance: 1650, feedInTariff: 0.04,
    pvInstallationCostPerKWp: 800, bessCostPerKWh: 300, heatPumpCostPerKW: 750,
    currency: 'EUR', vatRate: 21, co2GridFactor: 0.195,
    gasPricePerKWh: 0.085, oilPricePerKWh: 0.10,
  },
  {
    code: 'NL', name: 'Netherlands', flag: '🇳🇱',
    electricityPrice: 0.34, solarIrradiance: 950, feedInTariff: 0.09,
    pvInstallationCostPerKWp: 800, bessCostPerKWh: 300, heatPumpCostPerKW: 870,
    currency: 'EUR', vatRate: 21, co2GridFactor: 0.350,
    gasPricePerKWh: 0.13, oilPricePerKWh: 0.115,
  },
  {
    code: 'BE', name: 'Belgium', flag: '🇧🇪',
    electricityPrice: 0.33, solarIrradiance: 980, feedInTariff: 0.055,
    pvInstallationCostPerKWp: 800, bessCostPerKWh: 300, heatPumpCostPerKW: 860,
    currency: 'EUR', vatRate: 21, co2GridFactor: 0.165,
    gasPricePerKWh: 0.09, oilPricePerKWh: 0.105,
  },
  {
    code: 'AT', name: 'Austria', flag: '🇦🇹',
    electricityPrice: 0.25, solarIrradiance: 1150, feedInTariff: 0.082,
    pvInstallationCostPerKWp: 800, bessCostPerKWh: 300, heatPumpCostPerKW: 820,
    currency: 'EUR', vatRate: 20, co2GridFactor: 0.108,
    gasPricePerKWh: 0.10, oilPricePerKWh: 0.105,
  },
  {
    code: 'PL', name: 'Poland', flag: '🇵🇱',
    electricityPrice: 0.21, solarIrradiance: 1100, feedInTariff: 0.04,
    pvInstallationCostPerKWp: 800, bessCostPerKWh: 300, heatPumpCostPerKW: 700,
    currency: 'PLN', vatRate: 23, co2GridFactor: 0.700,
    gasPricePerKWh: 0.075, oilPricePerKWh: 0.095,
  },
  {
    code: 'CZ', name: 'Czech Republic', flag: '🇨🇿',
    electricityPrice: 0.22, solarIrradiance: 1100, feedInTariff: 0.045,
    pvInstallationCostPerKWp: 800, bessCostPerKWh: 300, heatPumpCostPerKW: 720,
    currency: 'CZK', vatRate: 21, co2GridFactor: 0.480,
    gasPricePerKWh: 0.09, oilPricePerKWh: 0.10,
  },
  {
    ...
    gasPricePerKWh: 0.13, oilPricePerKWh: 0.12,
  },
  {
    code: 'DK', name: 'Denmark', flag: '🇩🇰',
    electricityPrice: 0.38, solarIrradiance: 950, feedInTariff: 0.07,
    pvInstallationCostPerKWp: 800, bessCostPerKWh: 300, heatPumpCostPerKW: 880,
    currency: 'DKK', vatRate: 25, co2GridFactor: 0.120,
    gasPricePerKWh: 0.115, oilPricePerKWh: 0.12,
  },
  {
    code: 'PT', name: 'Portugal', flag: '🇵🇹',
    electricityPrice: 0.22, solarIrradiance: 1750, feedInTariff: 0.047,
    pvInstallationCostPerKWp: 800, bessCostPerKWh: 300, heatPumpCostPerKW: 740,
    currency: 'EUR', vatRate: 23, co2GridFactor: 0.210,
    gasPricePerKWh: 0.10, oilPricePerKWh: 0.11,
  },
  {
