...
export function ContactContent() {
  ...
  const channels = [
    { icon: Mail, label: c.emailLabel, value: 'hello@brinowatt.com', href: 'mailto:hello@brinowatt.com', note: c.emailNote },
    { icon: Phone, label: c.phoneLabel, value: '+40 746 987 892', href: 'tel:+40746987892', note: c.phoneNote },
    { icon: MapPin, label: c.officeLabel, value: c.officeValue, href: null, note: c.officeNote },
  ]
    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <section className="bg-white pt-24 lg:pt-32 pb-12 border-b border-neutral-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-neutral-600 max-w-2xl mx-auto">{c.subtitle}</p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-2xl shadow-card-lg border border-neutral-100 p-6 md:p-8">
                <h2 className="text-xl font-bold text-neutral-900 mb-1">{c.formTitle}</h2>
                <p className="text-sm text-neutral-500 mb-6">{c.formNote}</p>
                <ContactForm />
              </div>
            </div>
            ...
            <div className="space-y-6">
                      ...
                      <li key={ch.label} className="flex items-start gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          {ch.href ? (
                            ...
                            <div className="text-sm font-semibold text-neutral-900">{ch.value}</div>
                          )}
                          <div className="text-xs text-neutral-500 mt-0.5">{ch.note}</div>
                        </div>
                      </li>
                    )
                  })}
              ...
              <div className="bg-gradient-to-br from-brand-50 to-blue-50 rounded-2xl border border-brand-100 p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="text-sm font-bold text-neutral-900 mb-1">{c.quickTitle}</div>
                    <p className="text-xs text-neutral-600 leading-relaxed">{c.quickBody}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-neutral-100 p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="text-sm font-bold text-neutral-900 mb-1">{c.dataTitle}</div>
