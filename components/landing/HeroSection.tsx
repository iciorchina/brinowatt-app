...
const trustIndicators = [
  ...
  { icon: CheckCircle2, label: '500+ SMEs' },
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-green-50 border border-green-100 text-green-700 text-sm font-medium mb-8">
              ...
              Trusted by 500+ European businesses
            </div>
            ...
            <p className="text-lg sm:text-xl text-slate-500 leading-relaxed mb-8 max-w-lg">
              Solar PV, battery storage, and heat pumps — see the numbers before you commit.
              Precise estimates, expert guidance, and tailored offers for your business.
            </p>
          ...
          <div className="relative flex items-center justify-center lg:justify-end">
            ...
            <div className="relative w-full max-w-md">
              ...
              <div className="bg-white rounded-3xl border border-slate-100 shadow-2xl shadow-slate-200/60 overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-green-600 to-green-700 px-6 py-5">
                  ...
                  <h3 className="text-white text-lg font-bold">
                    PV 50 kWp + BESS 75 kWh
                  </h3>
                  <p className="text-green-100 text-sm mt-0.5">Mid-size commercial property, Germany</p>
                </div>
                ...
                <div className="p-6 grid grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2 flex items-center justify-between p-4 rounded-2xl bg-green-50 border border-green-100">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs text-green-700 font-medium">Annual Savings</p>
                  ...
                  <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
                    <p className="text-xs text-slate-500 font-medium mb-1">Payback Period</p>
                    <p className="text-xl font-bold text-slate-800">6.2 yrs</p>
                    <p className="text-xs text-slate-400 mt-0.5">From investment</p>
                  </div>

                  {/* CO2 reduction */}
                  <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
                    <p className="text-xs text-slate-500 font-medium mb-1">CO₂ Reduction</p>
                    <div className="flex items-center gap-1.5">
                      <Leaf className="w-4 h-4 text-green-500" />
                      <p className="text-xl font-bold text-slate-800">22 t/yr</p>
                    </div>
                    <p className="text-xs text-slate-400 mt-0.5">Annual offset</p>
                  </div>

                  {/* ROI */}
                  <div className="col-span-2 flex items-center justify-between p-4 rounded-2xl bg-blue-50 border border-blue-100">
                    <div>
                      <p className="text-xs text-blue-600 font-medium">10-Year ROI</p>
                      <p className="text-2xl font-extrabold text-blue-700">142%</p>
                    </div>
                    <div className="text-right">
                      <p className="text-xs text-blue-500">Net profit after</p>
                      <p className="text-sm font-semibold text-blue-600">10 years</p>
                    </div>
              ...
              <div className="absolute -bottom-4 -left-4 flex items-center gap-2 px-3.5 py-2.5 bg-white rounded-2xl shadow-lg border border-slate-100">
                ...
                <div>
                  <p className="text-xs text-slate-500 leading-none">Avg. savings</p>
                  <p className="text-sm font-bold text-slate-800 leading-none mt-0.5">35% energy costs</p>
                </div>
              </div>
            </div>
          </div>
